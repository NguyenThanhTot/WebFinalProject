                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="../sanpham/danh-sach-sp.jsp"><i class="fa fa-circle-o"></i>Danh Sách Sản
                                    Phẩm</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../donhang/tat-ca-don-hang.jsp"><i class="fa fa-circle-o"></i> Tất Cả Đơn
                                    Hàng</a></li>
                            <li><a href="../donhang/don-da-giao.jsp"><i class="fa fa-circle-o"></i> Đơn Đã Giao</a>
                            </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="../cauhinh/man-hinh-khoa.jsp"><i class="fa fa-circle-o"></i> Màn hình khóa</a>
                            </li>
                            ...
                            <li><a href="../cauhinh/trang-trong.jsp"><i class="fa fa-circle-o"></i> Trang Trống</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header">
                        <button class="btn btn-default pull-right btn_add_new_item"><i class="fa fa-plus"></i> Thêm
                            mới</button>
                    </div><!-- /.box-header -->
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                ...
                                <tr class="item_in_table">
                                    <td>1.</td>
                                    <td style="width: 100px;">BLACK FRIDAY – SALE SẬP SÀN HÀNG NGÀN ƯU ĐÃI LÊN ĐẾN 70%
                                    </td>
                                    <td style="width: 200px">
                                        Nhân dịp sinh nhật lên 7, 360 boutique GIẢM GIÁ LÊN ĐẾN 50% toàn bộ hoodie,
                                        khoác gió, quần jeans, quần âu, sweater, sơ mi và cả áo phông, kể cả HÀNG MỚI
                                        VỀ.
                                        <br>
                                        Chương trình SALE lớn nhất năm bạn nhanh chân rinh thật nhiều quà nhé!
                                    </td>
                                    <td>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Thêm bảng tin mới</h3>
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Cập nhật tin</h3>
                        ...
                        <form role="form">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="tieude">Tiêu đề</label>
                                    <input type="text" class="form-control" id="tieude" placeholder="Nhập tiêu đề"
                                        value="BLACK FRIDAY – SALE SẬP SÀN HÀNG NGÀN ƯU ĐÃI LÊN ĐẾN 70%">
                                </div>
                                <div class="form-group">
                                    <label for="noidung">Nội dung</label><br>
                                    <textarea name="" id="noidung" cols="65%"
                                        rows="10"> Nhân dịp sinh nhật lên 7, 360 boutique GIẢM GIÁ LÊN ĐẾN 50% toàn bộ hoodie,khoác gió, quần jeans, quần âu, sweater, sơ mi và cả áo phông, kể cả HÀNG MỚI VỀ. Chương trình SALE lớn nhất năm bạn nhanh chân rinh thật nhiều quà nhé!</textarea>
                                </div>
                                <div class="box-footer">
