          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="man-hinh-khoa.jsp"><i class="fa fa-circle-o"></i> Màn hình khóa</a></li>
                <li><a href="../cauhinh/404.html"><i class="fa fa-circle-o"></i> 404 Lỗi</a></li>
                <li><a href="500.jsp"><i class="fa fa-circle-o"></i> 500 Lỗi</a></li>
                <li><a href="trang-trong.jsp"><i class="fa fa-circle-o"></i> Trang Trống</a></li>
              </ul>
            </li>
          </ul>
        </section>
        ...
        <section class="content">
          ...
          <div class="error-page">
            ...
            <div class="error-content">
              <h3><i class="fa fa-warning text-yellow"></i> Oops! Trang không tìm thấy.</h3>
              <p>
                Chúng tôi không thể tìm thấy trang bạn đang tìm kiếm.
                Trong khi đó, bạn có thể quay lại <a href='../../index.jsp'>trang tổng quan</a> hoặc thử sử dụng biểu mẫu tìm kiếm.
              </p>
