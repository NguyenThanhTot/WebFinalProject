          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="404.jsp"><i class="fa fa-circle-o"></i> 404 Lỗi</a></li>
        ...
        <section class="content">
          ...
          <div class="error-page">
            ...
            <div class="error-content">
              <h3><i class="fa fa-warning text-red"></i> Ohh! Có điều gì đó không ổn.</h3>
              <p>
                Chúng tôi sẽ giải quyết để khắc phục vấn đề đó ngay lập tức.
              </p>
