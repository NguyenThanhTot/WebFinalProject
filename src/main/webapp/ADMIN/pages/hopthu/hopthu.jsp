                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-3 col-sm-4">
                      ...
                      <!-- compose message btn -->
                      <a class="btn btn-block btn-primary" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-pencil"></i> Tạo thư mới</a>
                      <!-- Navigation - folders-->
                      <div style="margin-top: 15px;">
                        <ul class="nav nav-pills nav-stacked">
                          <li class="header">Folders</li>
                          <li class="active"><a href="#"><i class="fa fa-inbox"></i> Hộp thư đến (14)</a></li>
                          <li><a href="#"><i class="fa fa-pencil-square-o"></i> Bản nháp</a></li>
                          <li><a href="#"><i class="fa fa-mail-forward"></i> Thư đã gửi</a></li>
                          <li><a href="#"><i class="fa fa-star"></i> Có gắn sao</a></li>
                          <li><a href="#"><i class="fa fa-folder"></i> Thư rác</a></li>
                        </ul>
                      </div>
                    </div><!-- /.col (LEFT) -->
                        ...
                        <div class="col-sm-6">
                          ...
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              ...
                              <li class="divider"></li>
                              <li><a href="#">Chuyển vào thùng rác</a></li>
                              <li class="divider"></li>
                              <li><a href="#">Xóa</a></li>
                            </ul>
                          </div>
                      ...
                      <div class="table-responsive">
                        ...
                        <table class="table table-mailbox">
                          <tr class="unread">
                            ...
                            <td class="name"><a href="read-mail.jsp">John Doe</a></td>
                            <td class="subject"><a href="read-mail.jsp">Urgent! Please read</a></td>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fa fa-envelope-o"></i> SOẠN THƯ MỚI</h4>
          </div>
          <form action="#" method="post">
            <div class="modal-body">
              ...
              <div class="form-group">
                <div class="btn btn-success btn-file">
                  <i class="fa fa-paperclip"></i> Đính kèm tệp
            ...
            <div class="modal-footer clearfix">
              ...
              <button type="submit" class="btn btn-primary pull-left"><i class="fa fa-envelope"></i> Gửi Tin</button>
            </div>
          </form>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
