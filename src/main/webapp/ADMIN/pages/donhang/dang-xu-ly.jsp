            ...
            <section class="sidebar">
              ...
              <ul class="sidebar-menu">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="tat-ca-don-hang.jsp"><i class="fa fa-circle-o"></i> Tất Cả Đơn Hàng</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="item_in_table">
                                            ...
                                            <td style="width: 100px">
                                                - <span class="MaSP_info">SMABC</span> X <span
                                                    class="SL_info">1</span><br>
                                                - <span class="MaSP_info">SMABA</span> X <span
                                                    class="SL_info">1</span><br>
                                                - <span class="MaSP_info">SMABC</span> X <span
                                                    class="SL_info">1</span><br>
                                            </td>
