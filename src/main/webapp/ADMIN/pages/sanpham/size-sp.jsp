            ...
            <div class="box-body no-padding">
              <table class="table table-condensed">
                <tbody><tr>
                  ...
                  <th style="width: 200px">SIZE SẢN PHẨM</th>
            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập mã màu">
                </div>
                <div class="form-group">
          ...
          <div class="box box-primary">
            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Mã sản phẩm</label>
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập mã màu" value="SMABC">
                </div>
                <div class="form-group">
                  <label for="size-sp">Size sản phẩm</label>
                  <div class="checkbox" id="size-sp">
