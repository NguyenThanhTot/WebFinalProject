      ...
      <div class="box">
        ...
        <div class="box-body no-padding">
          <table class="table table-condensed">
            <tbody><tr>
              <th style="width: 200px">MÃ SIZE</th>
              <th style="width: 200px">TÊN SIZE</th>
              ...
              <tr class="item_in_table">
                ...
                <td>
                  <div style="font-size: 18px;" class="my_editANDremove">
                    ...
                    <a href="deleteSize?uid=${size.size_id}" class="fa fa-trash-o btn-del-item"></a>
                  </div>
                </td>
              </tr>
            </c:forEach>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title">Tạo size mới</h3>
            <i class="fa fa-times" id="close-form-addnew"></i>
          </div><!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="AddSize" method="post">
            <div class="box-body">
              <div class="form-group">
                <label for="size_id_add">Id size</label>
                <input name="size_id_add" type="text" class="form-control" id="size_id_add" placeholder="Nhập mã size">
              </div>
              <div class="form-group">
                <label for="size_name_add">Tên size</label>
                <input name="size_name_add" type="text" class="form-control" id="size_name_add"  placeholder="Nhập tên size">
              </div>
  ...
  <section>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title">Chỉnh sửa màu</h3>
          ...
          <form role="form">
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="" placeholder="Nhập mã màu" value="SMABC">
              </div>
              <div class="form-group">
                <label for="size-sp">Size sản phẩm</label>
                <div class="checkbox" id="size-sp">
                  <label for="size-s">
                    <input type="checkbox" id="size-s" checked="checked" value="S"> S
                  </label>
                  <label>
                    <input type="checkbox" id="size-m" checked="checked" value="M"> M
                  </label>
                  <label>
                    <input type="checkbox" id="size-l" checked="checked" value="L"> L
                  </label>
                </div>
              </div>
              <div class="form-group">
