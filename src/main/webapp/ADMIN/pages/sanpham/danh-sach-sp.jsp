            ...
            <table class="table table-hover">
              <tbody>
                <tr>
                  ...
                  <th style="width: 150px">MÀU SP</th>
                  <th style="width: 150px">ẢNH SP</th>
                  <th style="width: 100px"></th>
                </tr>
                <tr class="item_in_table">
                  <td style="width: 40px">1.</td>
                  <td style="width: 150px">SMABC</td>
                  <td style="width: 200px">Áo sơ mi ABC</td>
                  <td style="width: 150px">NAM</td>
                  <td style="width: 150px">ÁO SƠ MI</td>
                  <td style="width: 150px">S M L</td>
                  <td style="width: 150px">199000đ</td>
                  <td style="width: 150px"><a href="">Xem chi tiết</a></td>
                  <td style="width: 150px"><a href="">Xem chi tiết</a></td>
            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="ma_sp" placeholder="Nhập mã sản phẩm">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="danhmuc_sp" placeholder="Nhập danh mục">
                </div>
                <div class="form-group">
                  <label for="loai_sp">Loại</label>
                  <input type="text" class="form-control" id="loai_sp" placeholder="Nhập loại">
                </div>
                <div class="form-group">
