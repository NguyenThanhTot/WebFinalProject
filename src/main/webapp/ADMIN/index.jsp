                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-right">
                      <a href="pages/cauhinh/dang-nhap.jsp" class="btn btn-default btn-flat">Đăng xuất</a>
                    </div>
                  </li>
                </ul>
              </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/sanpham/mau-sac.jsp"><i class="fa fa-circle-o"></i>Màu Sắc</a></li>
                <li><a href="pages/sanpham/size-sp.jsp"><i class="fa fa-circle-o"></i>Size Sản Phẩm</a></li>
                <li><a href="pages/sanpham/danh-sach-sp.jsp"><i class="fa fa-circle-o"></i>Danh Sách Sản Phẩm</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/donhang/tat-ca-don-hang.jsp"><i class="fa fa-circle-o"></i> Tất Cả Đơn Hàng</a></li>
                <li><a href="pages/donhang/don-da-giao.jsp"><i class="fa fa-circle-o"></i> Đơn Đã Giao</a></li>
                <li><a href="pages/donhang/dang-xu-ly.jsp"><i class="fa fa-circle-o"></i> Đang xử lý</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="pages/khachhang/khachhang.jsp">
                <i class="fa fa-users"></i>
                <span>Khách Hàng</span>
              </a>
            </li>
            <li class="treeview">
              <a href="pages/bangtin/bangtin.jsp">
                <i class="fa  fa-comment-o"></i>
                <span>Bảng tin</span>
              </a>
            </li>
            <li>
              <a href="pages/hopthu/hopthu.jsp">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/cauhinh/dang-nhap.jsp"><i class="fa fa-circle-o"></i> Đăng Nhập</a></li>
                <li><a href="pages/cauhinh/man-hinh-khoa.jsp"><i class="fa fa-circle-o"></i> Màn hình khóa</a></li>
                <li><a href="pages/cauhinh/404.jsp"><i class="fa fa-circle-o"></i> 404 Lỗi</a></li>
                <li><a href="pages/cauhinh/500.jsp"><i class="fa fa-circle-o"></i> 500 Lỗi</a></li>
                <li><a href="pages/cauhinh/trang-trong.jsp"><i class="fa fa-circle-o"></i> Trang Trống</a></li>
              </ul>
            </li>
          </ul>
        </section>
