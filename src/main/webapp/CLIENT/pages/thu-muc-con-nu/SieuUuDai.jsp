...
<body>
            ...
            <div class="col-8 bg-white">
                ...
                <div class="menu-icon">
                    <div class="justify-content-center">
                        ...
                        <hr>
                        <a href="../other/uu-dai.jsp" class="menu-item d-flex justify-content-center text-dark">Khuyến
                            mãi</a>
                        <hr>
                ...
                <div class="mt-3 mb-4 row justify-content-center">
                    <div class="col-6 col-sm-5 d-flex justify-content-start">
                        <div class="pt-2 pb-2 btn btn-dark">
                            <a href="../other/gio-hang.jsp" style="text-decoration: none; color: #fff; font-size: 12px;">XEM
                                GIỎ
                                HÀNG</a>
                        </div>
                    </div>
                    <div class="col-6 col-sm-5 d-flex justify-content-end">
                        <div class="pt-2 pb-2 btn btn-dark">
                            <a href="../other/thanh-toan.jsp"
                                style="text-decoration: none; color: #fff; font-size: 12px;">THANH
                                TOÁN</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container mt-4 mb-4">
        <div id="menu_chilren_NAMNU">
            <ul>
                <li><a href="ThuMucConNu/AoHoodie.html">HOODIE</a></li>
                <li><a href="ThuMucConNu/AoKhoac.html">ÁO KHOÁC</a></li>
                <li><a href="ThuMucConNu/Aosomi.html">SƠ MI</a></li>
                <li><a href="ThuMucConNu/AoThun.html">ÁO THUN</a></li>
                <li><a href="ThuMucConNu/Quan.html">QUẦN</a></li>
                <li><a href="ThuMucConNu/Vay.html">VÁY</a></li>
                <li><a href="ThuMucConNu/Yem.html">YẾM</a></li>
            </ul>
        </div>
    </div>
    <!--End Menu con-->
    <div class="container mb-4 bg-light p-2 mt-4">
        ...
        <span>/</span>
        <a href="../ThuMucConNu/SieuUuDai.jsp" class="category-present text-dark"
           style="font-weight: 500; text-decoration: none;">Siêu ưu đãi</a>
    </div>
    <div class="container mb-5">
        ...
        <div class="row justify-content-center">
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../../img/Nu/Yem/yem7.jpg);">
                </div>
            ...
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../../img/Nu/AoSomi/somi18.jpg);">
                </div>
                <b class="title-product d-flex justify-content-center mt-2">Áo thun Oversize Unisex UNS12</b>
                <div class="price-product mb-4">
                    <div class="price_pd_left">
        ...
        <div class="row justify-content-center">
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../../img/Nu/Yem/yem3.jpg);">
                </div>
                <b class="title-product d-flex justify-content-center mt-2">Yếm jean tua tua đính chữ DY72</b>
                <div class="price-product mb-4">
                    <div class="price_pd_left">
        ...
        <div class="row justify-content-center">
            ...
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../../img/Nu/AoThun/thun14.jpg);">
                </div>
                <b class="title-product d-flex justify-content-center mt-2">Áo thun cotton tay ngắn CT25</b>
                <div class="price-product mb-4">
                    <div class="price_pd_left">
            ...
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../../img/Nu/AoSomi/somi10.jpg);">
                </div>
                <b class="title-product d-flex justify-content-center mt-2">Áo thun Oversize Unisex UNS12</b>
                <div class="price-product mb-4">
                    <div class="price_pd_left">
