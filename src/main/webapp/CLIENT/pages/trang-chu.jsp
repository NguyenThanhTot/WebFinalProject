...
<body>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-sm-9 justify-content-end d-flex align-self-center pr-0">
                    <a href="../pages/trang-chu.jsp" class="menu-item pr-4"> Trang chủ<div class="underline_menu-item"></div></a>
                    <a href="../pages/other/Nam.jsp" class="menu-item pr-4">Nam<div class="underline_menu-item"></div></a>
                    <a href="../pages/other/Nu.jsp" class="menu-item pr-4">Nữ<div class="underline_menu-item"></div></a>
                    <a href="../pages/other/uu-dai.jsp" class="menu-item pr-4 ">Ưu đãi<div class="underline_menu-item"></div></a>
                    <a href="../pages/other/bang-tin.jsp" class="menu-item pr-4">Tin tức<div class="underline_menu-item"></div></a>
                </div>
                <div class="col-sm-2 align-self-center  d-flex justify-content-end p-0">
                    <a href="../pages/other/dang-nhap.jsp" class="fa fa-heart icon_menu_right" style="text-decoration: none;"></a>
                    <a href="../pages/other/dang-nhap.jsp" class="fa fa-user icon_menu_right"></a>
            ...
            <div class="col-8 bg-white">
                ...
                <div class="menu-icon">
                    <div class="justify-content-center">
                        ...
                        <hr>
                        <a href="../pages/other/Nam.jsp" class="menu-item d-flex justify-content-center text-dark">Nam</a>
                        <hr>
                        <a href="../pages/other/Nu.jsp" class="menu-item d-flex justify-content-center text-dark">Nữ</a>
                        <hr>
                        <a href="../pages/other/uu-dai.jsp" class="menu-item d-flex justify-content-center text-dark">Khuyến mãi</a>
                        <hr>
                        <a href="../pages/other/bang-tin.jsp" class="menu-item d-flex justify-content-center text-dark">Tin tức</a>
                        <hr>
                    </div>
                </div>
            </div>
                ...
                <div class="mt-3 mb-4 row justify-content-center">
                    <div class="col-6 col-sm-5 d-flex justify-content-start">
                        <div class="pt-2 pb-2 btn btn-dark">
                            <a href="../pages/other/gio-hang.jsp" style="text-decoration: none; color: #fff; font-size: 12px;">XEM GIỎ
                                HÀNG</a>
                        </div>
                    </div>
                    <div class="col-6 col-sm-5 d-flex justify-content-end">
                        <div class="pt-2 pb-2 btn btn-dark">
                            <a href="../pages/other/thanh-toan.jsp" style="text-decoration: none; color: #fff; font-size: 12px;">THANH
                                TOÁN</a>
                        </div>
                    </div>
                </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="../dist/img/carousel/carousel1.jpg" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="../dist/img/carousel/carousel2.jpg" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="../dist/img/carousel/carousel3.jpg" alt="Third slide">
                </div>
            </div>
    ...
    <section class="under-slide-carousel pt-5 pb-5" style="background-color: #f7f7f7;">
        <div class="container-fluid">
            <div class="container">
                <div class="row">
                    <div class="col-6 col-md-6 p-0 img-topic">
                        <img src="../dist/img/product\bo_suu_tap_ao_thun_khac_biet5.jpg" alt="" class="img-fluid">
                        <div class="xemthem-bg">
                            <a href="other/Nam.jsp" style="text-decoration: none;">
                                <div class="btn-xemthem">XEM THÊM</div>
                            </a>
                        </div>
                    </div>
                    <div class="col-6 col-md-6 p-0 img-topic">
                        <img src="../dist/img/product\bo_suu_tap_ao_thun_khac_biet6.jpg" alt="" class="img-fluid">
                        <div class="xemthem-bg">
                            <a href="other/Nu.jsp" style="text-decoration: none;">
                                <div class="btn-xemthem">XEM THÊM</div>
                            </a>
                        </div>
                    </div>
    ...
    <div class="container mt-4 mb-4">
        ...
        <div class="row justify-content-center" style="padding: 0; margin: 0;">
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../dist/img/Img_Nam/Aothun/aoform1e.png);">
                </div>
            ...
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../dist/img/Nu/Quan/quan3.jpg);">
                </div>
                <b class="title-product d-flex justify-content-center mt-2">Quần legging thun ôm LG66</b>
                <div class="price-product mb-4">
                    <div class="price_pd_left">
            ...
            <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                <div class="image-product mt-3" style="background-image: url(../dist/img/Nu/Vay/vay4.jpg);">
                </div>
                <b class="title-product d-flex justify-content-center mt-2">Chân váy dây xích cá tính CT85</b>
                <div class="price-product mb-4">
                    <div class="price_pd_left">
    ...
    <div class="register_take_news .container-fluid bg-secondary">
        <div class="container p-0">
            <div class="row pt-4 pb-4">
                <div class="col-12 col-sm-12 col-md-5 col-lg-7 mt-4 mb-3 image-register_take_news" style="background-image: url(../dist/img/Home/b_ng-tin_2-3_1.jpg);">
                </div>
                <div class="col-12 col-sm-12 col-md-7 col-lg-5 mt-4 mb-3 d-flex align-self-center justify-content-center">
                    <div>
                        <h4 class="d-flex justify-content-center text-white">ĐĂNG KÝ NHẬN BẢNG TIN</h4>
                        <p class="d-flex justify-content-center text-white">Đừng bỏ lỡ hàng ngàn sản phẩm và chương trình siêu hấp dẫn</p>
                        <input type="text" name="email_register_take_news" id="email_register_take_news" placeholder="Nhập email của bạn">
                        <div class="btn btn-light mt-3" style="width: 100%; font-weight: 600;">ĐĂNG KÝ</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt-5 pd-4">
        <div id="reasonChoose" class="container">
            <div class="row">
                <div class="reasonChoose_item col-lg-3 col-12 d-flex flex-column justify-content-center">
                    <img src="../dist/img/reasonChoose/services1.svg" alt="" class="img-fluid mb-2" style="max-height: 40px;">
                    <h5 class="align-self-center" style="font-family: 'Arima Madurai', cursive;">Giao hàng toàn quốc
                    </h5>
                    <p class="align-self-center">Bất kỳ giá trị đơn hàng</p>
                </div>
                <div class="reasonChoose_item col-lg-3 col-12 d-flex flex-column justify-content-center">
                    <img src="../dist/img/reasonChoose/services2.svg" alt="" class="img-fluid mb-2" style="max-height: 40px;">
                    <h5 class="align-self-center" style="font-family: 'Arima Madurai', cursive;">Thanh toán an toàn</h5>
                    <p class="align-self-center">Yên tâm shopping</p>
                </div>
                <div class="reasonChoose_item col-lg-3 col-12 d-flex flex-column justify-content-center">
                    <img src="../dist/img/reasonChoose/services3.svg" alt="" class="img-fluid mb-2" style="max-height: 40px;">
                    <h5 class="align-self-center" style="font-family: 'Arima Madurai', cursive;">Chính sách hoàn tiền
                    </h5>
                    <p class="align-self-center">An tâm chất lượng</p>
                </div>
                <div class="reasonChoose_item col-lg-3 col-12 d-flex flex-column justify-content-center">
                    <img src="../dist/img/reasonChoose/services4.svg" alt="" class="img-fluid mb-2" style="max-height: 40px;">
                    <h5 class="align-self-center" style="font-family: 'Arima Madurai', cursive;">Hỗ trợ trực tuyến</h5>
                    <p class="align-self-center">Giải đáp thắc mắc nhanh chóng</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../dist/js/onClickProduct.js"></script>
