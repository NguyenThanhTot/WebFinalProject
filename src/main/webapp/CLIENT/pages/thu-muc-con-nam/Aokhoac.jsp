...
<body>
    ...
    <div class="container mb-4 bg-light p-2 mt-4">
        ...
        <span>/</span>
        <a href="../other/Nam.jsp" class="category-present text-dark"
           style="font-weight: 500; text-decoration: none;">Nam</a>
        <span>/</span>
        <a href="Aokhoac.jsp" class="category-present text-dark" style="font-weight: 500; text-decoration: none;">Áo
            khoác</a>
    </div>
