...
<body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="../img/uudai3.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="../img/uudai2.jpg" alt="Second slide">
              </div>
            </div>
    ...
    <section>
        <div class="container mt-4 mb-4">
            <h4 class="d-flex justify-content-center">ĐỒNG GIÁ 299K</h4>
            <div class="row justify-content-center">
            ...
            <h4 class="d-flex justify-content-center mt-4">ƯU ĐÃI NOEL</h4>
            <div class="row justify-content-center">
                <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                ...
                <div class="product-item col-5 col-md-4 col-lg-3 pb-3">
                    ...
                    <b class="title-product d-flex justify-content-center mt-2">Áo sơ mi sọc caro</b>
                    <div class="price-product mb-4">
                        <div class="price_pd_left">
                            <p class="price-cost mt-1 mb-0" style="font-size: 14px; color: red;">299.000vnd</p>
                            <strike class="price-discount" style="font-size: 12px;">350.000vnd</strike>
