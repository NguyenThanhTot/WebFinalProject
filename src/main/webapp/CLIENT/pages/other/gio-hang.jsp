...
<head>
    ...
    <link rel="stylesheet" href=".././my_css/giohang.css">
</head>
...
<body>
    ...
    <div class="container mb-4 bg-light p-2 mt-4">
        ...
        <span>/</span>
        <a href="" class="category-present text-dark" style="font-weight: 500; text-decoration: none;">Giỏ hàng</a>

    </div>

    <!-- Table detail don hang -->
    <div class="container-fluid">
        <div class="container pb-5">

            <div class="table-cart-pc">
                <div class="menu-cart">
                    <div class="row pt-2 pb-2 bg-dark text-light">
                        <div class="image-product col-sm-2"></div>
                        <div class="col-sm-3 d-flex justify-content-center">Sản phẩm</div>
                        <div class="col-sm-2 d-flex justify-content-center">Giá</div>
                        <div class="col-sm-2 d-flex justify-content-center">Số lượng</div>
                        <div class="col-sm-2 d-flex justify-content-center">Tạm tính</div>
                    </div>
                </div>
                <div class="product_detail ">
                    <div class="row border border-top-0 border-secondary">
                        <div class="col-sm-2 pt-4 pb-4 d-flex justify-content-end">
                            <img src=".././img/Nu/AoThun/thun3.jpg" alt="" class="img-fluid" style="max-height: 100px;">
                        </div>
                        <div class="col-sm-3 align-self-center d-flex justify-content-center">
                        ...
                        <div class="col-sm-2 align-self-center d-flex justify-content-center">
                            <input type="number" value="1" maxlength="2" style="width: 40%;">
                        </div>
                        <div class="col-sm-2 align-self-center d-flex justify-content-center">
                            290.000Đ
                        </div>
                    ...
                    <div class="row border border-top-0 border-secondary">
                        <div class="col-sm-2 pt-4 pb-4 d-flex justify-content-end">
                            <img src="../../img/Img_Nam/Aokhoac/aokhoac3a.png" alt="" class="img-fluid" style="max-height: 100px;">
                        </div>
                        <div class="col-sm-3 align-self-center d-flex justify-content-center">
                            Áo khoác kaki unisex TH Store - Đỏ, L
                        </div>
                        <div class="col-sm-2 align-self-center d-flex justify-content-center">
                            197.000Đ
                        </div>
                    ...
                    <div class="row border border-top-0 border-secondary">
                        <div class="col-sm-2 pt-4 pb-4 d-flex justify-content-end">
                            <img src="../../img/Img_Nam/Asomi/aosomi14b.png" alt="" class="img-fluid" style="max-height: 100px;">
                        </div>
                        <div class="col-sm-3 align-self-center d-flex justify-content-center">
            ...
            <div class="table-cart-mobile container mt-4">
                <div class="product-row">
                    <div class="title-product-row row bg-dark text-white pt-2 pb-2">
                        <i class="fa fa-times mr-3 ml-3 align-self-center" aria-hidden="true"></i>
                        Áo thun Oversize Unisex UNS12 - Trắng, L
                    </div>
                    <div class="row justify-content-between border border-top-0">
                        <div class="col-3 m-3 p-0">
                            <img src=".././img/Nu/AoThun/thun3.jpg" alt="" class="img-fluid" style="max-height: 100px;">
                        </div>
                        <div class="col-4 align-self-center p-0">
                            <input type="number" value="1" maxlength="2" style="width:25%;">
                            <div class="price" style="font-size: 14px;">290.000Đ <span>x1</span></div>
                            <div class="price-total" style="font-size: 14px;">290.000Đ</span></div>
                        </div>
                    </div>
                </div>
                <div class="product-row">
                    ...
                    <div class="row justify-content-between border border-top-0">
                        ...
                        <div class="col-4 align-self-center p-0">
                            <input type="number" value="1" maxlength="2" style="width:30%;">
                            <div class="price" style="font-size: 14px;"> 197.000Đ <span>x1</span></div>
                            <div class="price-total" style="font-size: 14px;"> 197.000Đ</span></div>
                        </div>
                    </div>
                </div>
                <div class="product-row">
                    ...
                    <div class="row justify-content-between border border-top-0">
                        ...
                        <div class="col-4 align-self-center p-0">
                            <input type="number" value="1" maxlength="2" style="width:30%;">
                            <div class="price" style="font-size: 14px;"> 350.000Đ <span>x1</span></div>
                            <div class="price-total" style="font-size: 14px;"> 350.000Đ</span></div>
                        </div>
                    </div>
                </div>
            </div>

            <div class="update mt-4 mb-3 container">
                <div class="row justify-content-end">
                    <div class="btn btn-primary col-5">Cập nhật giỏ hàng</div>
                </div>
            </div>
            <div class="in4_ship">
                ...
                <div class="row justify-content-end">
                    <div class="col col-md-4">
                        ...
                        <div class="row tamtinh">
                            ...
                            <div class="col-6 col-sm-6"> 837.000Đ</div>
                        </div>
                        <div class="row tamtinh">
                            <div class="col-6 col-sm-6">
                                <h6>Tổng</h6>
                        ...
                        <div class="mt-4 btn btn-dark d-flex justify-content-center">
                            <a href="thanh-toan.jsp" class="text-white" style="text-decoration: none;">TIẾN HÀNH THANH
                                TOÁN</a>
                        </div>
                    </div>
                </div>
