            ...
            <div class="row justify-content-between mt-5">
                <div class="col-lg-5">
                    ...
                    <div class="login_password border border-secondary rounded mt-4 p-3">
                        ...
                        <div style="width: 44%; margin-left: auto; margin-right: auto;">giảm giá lên đến 15%*</div>
                        <div class="mt-3">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="register_password border border-secondary rounded mt-4 p-3">
                        <img src="../img/account/phone.png" alt="" class="img-fluid d-flex m-auto">
                        <div class="row justify-content-center mt-4 mb-4">
                            <div class="col-4 col-sm-4 btn btn-primary">
                                <a href="dang-ky.jsp" style="color: white; text-decoration: none;">ĐĂNG KÝ NHANH</a>
                            </div>
                        </div>
                    </div>
                </div>
