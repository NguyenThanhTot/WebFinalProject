            ...
            <div class="row justify-content-sm-center">
                ...
                <div class="col-sm-7 ">
                    <form action="" class="form-contact ">
                        <h2>Nhập vào thông tin</h2>
                        <span>Hãy điền vào thông tin cá nhân của bạn để chúng tôi trả lời bạn nhanh nhất có thể.</span>
                        <div class="row  mt-3">
                            <input type="text" id="form-input" placeholder="Tên">
                        </div>
                        <div class="row mt-3">
                            <input type="text" id="form-input" placeholder="Email">
                        </div>
                        <div class="row mt-3">
                            <input type="text" id="form-input" placeholder="Bạn đang nghĩ gì?">

                        </div>

                        <div class="row mt-3 justify-content-end"> <input class="col-6" type="submit" value="Gửi"></div>


                    </form>
                </div>
                <div class="col-sm-5">
                    <form action="" class="block-contact">
                        <h2>Cửa hàng</h2>
                        <ul>
                            <li>
                                <i class="fas fa-phone"></i>
                                <a href=""><strong>Hotline</strong> 1800.1099</a>
                            </li>
                            <li>
                                <i class="far fa-clock"></i>
                                <a href=""><strong>Thời gian mở cửa</strong>8:00 - 19:00 Thứ 2 - Thứ 7</a>
                            </li>
                            <li>
                                <i class="fas fa-map-marker-alt"></i>

                                <a href=""><strong>Khu vực phí Bắc</strong>Tầng 17 tòa nhà Viwaseen, 48 Phố Tố Hữu, Trung Văn, Nam Từ Liêm, Hà Nội.</a>
                            </li>
                            <li>
                                <i class="fas fa-map-marker-alt"></i>

                                <a href=""><strong>Khu vực phí Nam</strong>Lô III.25, Đường 19/5A, Nhóm CN III, Khu Công Nghiệp Tân Bình, P. Tây Thạnh, Q. Tân Phú, HCM.</a>
                            </li>
                        </ul>
