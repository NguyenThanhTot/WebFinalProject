...
<body>
    ...
    <div class="container mb-4 bg-light p-2 mt-4">
        ...
        <span>/</span>
        <a href="chi-nhanh.html" class="category-present text-dark" style="font-weight: 500; text-decoration: none;">Hệ thống DTD</a>
    </div>
                    ...
                    <form action="" class="block-contact">
                        ...
                        <ul>
                            <p>
                                ...
                                <strong>VP Phía Bắc:</strong> Tầng 17 tòa nhà Viwaseen, 48 Phố Tố Hữu, Trung Văn, Nam Từ Liêm, Hà Nội.
                            </p>
                            <img class="img-fluid" src="../img/Img_Nam/Hinh/bando.jpg" alt="">
                        </ul>
            ...
            <div class="row pt-4">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-2">
                    ...
                    <div class="mt-1"><a href="gioi-thieu.jsp" style="text-decoration: none; color:gray; font-size: 14px;">Giới thiệu
                            DTD</a></div>
                    <div class="mt-2"><a href="chi-nhanh.html" style="text-decoration: none; color:gray; font-size: 14px;">Hệ thống
                            cửa hàng</a></div>
