...
<body>
    ...
    <div class="containerr-fluid mb-5">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-6 mt-4">
                    <div class="container mb-4 bg-light p-2">
                        <a href="gio-hang.jsp" class="category-present text-dark" style="font-weight: 500; text-decoration: none;">Giỏ hàng</a>
                    ...
                    <div class="product-detail row justify-content-center">
                        ...
                        <div class="col-7 col-sm-8 pt-2">
                            <div class="row" style="font-size: 13px;">
                                ...
                                <div class="ml-2 d-flex justify-content-center text-white" style="background-color: grey; width: 24px; height: 24px; border-radius: 50%;">1</div>
                            </div>
                            <div class="row pt-2">
                                290.000Đ
                            </div>
                    ...
                    <div class="row mt-4 justify-content-between">
                        <div class="col-5 col-sm-5 align-self-center">
                            <div class="pt-2 pb-2">TỔNG CỘNG</div>
                        </div>
                        <div class="col-5 col-sm-5 align-self-center d-flex justify-content-end">
                           <div style="font-size: 30px;">837.000Đ</div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 pr-5 pl-5 mt-4 border-left">
                    <div class="info_order">
                        <h6>THÔNG TIN GIAO HÀNG</h6>
                        <div class="row mt-3">
                            <input type="text" placeholder="Họ và tên*" style="padding-left: 15px; width: 100%; height: 45px;">
                        </div>
                        <div class="row mt-3 justify-content-between">
                            <div class="col-7 col-sm-7 p-0">
                                <input type="email" placeholder="Email" style="padding-left: 15px; width: 100%; height: 45px;">
                            </div>
                            <div class="col-4 col-sm-4 p-0">
                                <input type="tel" placeholder="Số điện thoại*" style="padding-left: 15px; width: 100%; height: 45px;">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <input type="text" placeholder="Địa chỉ*" style="padding-left: 15px; width: 100%; height: 45px;">
                        </div>
                        <div class="row mt-3">
                            <input type="text" placeholder="Ghi chú" style="padding-left: 15px; width: 100%; height: 45px;">
                        </div>
                        <h6 style="margin: 15px 0;">Các ô có dấu * cần điền đầy đủ thông tin.</h6>
                        <div>Phí ship sẽ được tính theo từng địa chỉ , hỗ trợ ship trên hoá đơn trên 500K, tối thiểu 20K</div>
                        <div class="row mt-5">
                            <div class="col-6 col-sm-6 align-self-center">
                                <i class="fa fa-angle-left" aria-hidden="true" style="color: blue;"></i>
                                <a href="gio-hang.jsp" style="text-decoration: none;">Giỏ hàng</a>
                            </div>
                            <div class="col-6 col-sm-6 d-flex justify-content-end">
                                <a href="../trang-chu.jsp">
                                    <div class="btn btn-primary">Hoàn tất đơn hàng</div>
                                </a>
                            </div>
